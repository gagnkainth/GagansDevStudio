...
export function WorldMap({ 
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: "#00000040", // Light theme dots
      shape: "circle",
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-sm font-medium px-2 py-0.5 rounded-md bg-white/95 text-black border border-gray-200 shadow-sm whitespace-nowrap">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
